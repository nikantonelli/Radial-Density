...
//            .style("stroke", "#fff")
    ...
    //                 return d.data.record.get('DisplayColor')?d.data.record.get('DisplayColor'): 'lavenderblush';
    //             } else if (d.data.record.isTask()) {
    //                 return d.data.record.get('DisplayColor')?d.data.record.get('DisplayColor'): 'lemonchiffon';
    //             }
    //             else return d.data.record.get('DisplayColor')?d.data.record.get('DisplayColor'): 'aliceblue';
    //         });
